...
export interface AaroModullerSatinAlmaTalepListeListeModel {
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerSatinAlmaTalepListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerSatinAlmaTalepListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: string;
  KartTipID?: AaroModullerSatinAlmaTalepListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
