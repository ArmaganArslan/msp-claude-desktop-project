...
export interface AaroModullerAlinanSiparisListeListeModel {
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerAlinanSiparisListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerAlinanSiparisListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: string;
  KartTipID?: AaroModullerAlinanSiparisListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
