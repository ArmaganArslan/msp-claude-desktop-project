...
export interface AaroModullerVerilenSiparisListeListeModel {
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerVerilenSiparisListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerVerilenSiparisListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: string;
  KartTipID?: AaroModullerVerilenSiparisListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
