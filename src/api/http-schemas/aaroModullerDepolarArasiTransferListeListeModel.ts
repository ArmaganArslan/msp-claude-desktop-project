...
export interface AaroModullerDepolarArasiTransferListeListeModel {
  CariID?: number;
  CariTipID?: AaroModullerDepolarArasiTransferListeListeModelCariTipID;
  ...
  eFatura?: boolean;
  eFaturaTurID?: AaroModullerDepolarArasiTransferListeListeModelEFaturaTurID;
  eFaturaTurAdi?: string;
  eFaturaUUID?: string;
  eFaturaProfilID?: AaroModullerDepolarArasiTransferListeListeModelEFaturaProfilID;
  eFaturaProfilAdi?: string;
  eFaturaTipID?: AaroModullerDepolarArasiTransferListeListeModelEFaturaTipID;
  eFaturaTipAdi?: string;
  eFaturaDurumID?: AaroModullerDepolarArasiTransferListeListeModelEFaturaDurumID;
  ...
  eFaturaUygulamaYanitiDurumID?: AaroModullerDepolarArasiTransferListeListeModelEFaturaUygulamaYanitiDurumID;
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerDepolarArasiTransferListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerDepolarArasiTransferListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: string;
  KartTipID?: AaroModullerDepolarArasiTransferListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
