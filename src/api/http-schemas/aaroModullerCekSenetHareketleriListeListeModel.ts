...
export interface AaroModullerCekSenetHareketleriListeListeModel {
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerCekSenetHareketleriListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerCekSenetHareketleriListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: string;
  KartTipID?: AaroModullerCekSenetHareketleriListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
