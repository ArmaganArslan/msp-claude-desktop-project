...
export interface AaroModullerCariHareketleriListeListeModel {
  CariID?: number;
  CariTipID?: AaroModullerCariHareketleriListeListeModelCariTipID;
  MuhtelifCariAdi?: string;
  MuhtelifVergiNo?: string;
  MuhtelifVergiDairesi?: string;
  BayiMi?: boolean;
  BeklenenTahsilatOdemeID?: number;
  eFaturaTipi?: AaroModullerCariHareketleriListeListeModelEFaturaTipi;
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerCariHareketleriListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerCariHareketleriListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: Date;
  KartTipID?: AaroModullerCariHareketleriListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
