...
export interface AaroModullerKasaHareketleriListeListeModel {
  ...
  DgsKodu?: string;
  DgsAdi?: string;
  OnayDurum?: AaroModullerKasaHareketleriListeListeModelOnayDurum;
  Durum?: boolean;
  HareketID?: number;
  DekontID?: number;
  SubeID?: number;
  SirketID?: number;
  TipID?: AaroModullerKasaHareketleriListeListeModelTipID;
  ...
  DgsID?: number;
  DgsTar?: Date;
  KartTipID?: AaroModullerKasaHareketleriListeListeModelKartTipID;
  Kod1Kodu?: string;
  Kod2Kodu?: string;
  Kod3Kodu?: string;
  Kod4Kodu?: string;
